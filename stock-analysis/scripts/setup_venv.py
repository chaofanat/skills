...
def main():
    ...
    print("\n" + "-" * 60)
    print("[Optional] Configure GM (掘金) data source:")
    print("-" * 60)
    print("Set the following environment variables to use GM instead of akshare:")
    print("")
    print("  Windows (User level, restart terminal after):")
    print('    [System.Environment]::SetEnvironmentVariable("DATA_SOURCE", "gm", "User")')
    print('    [System.Environment]::SetEnvironmentVariable("GM_TOKEN", "<your_token>", "User")')
    print("")
    print("  Linux/macOS (add to ~/.bashrc or ~/.zshrc):")
    print('    export DATA_SOURCE=gm')
    print('    export GM_TOKEN=<your_token>')
    print("")
    print("  GM Token: 掘金终端 → 系统设置 → 密钥管理")
    print("=" * 60)
